...
class DockerSetupState
{
    ...
    public static function isSetupDone(): bool
    {
        ...
        // Ambiente local (ex.: Docker Compose no PC de desenvolvimento):
        // localhost é um domínio válido. Em produção (APP_ENV != local) mantém
        // a exigência de um domínio público.
